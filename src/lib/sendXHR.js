/**
	* @param {string} addressAndPort The address and port of your ESP32/Mock Server. Example: addressAndPort="127.0.0.1:8000"
...
export default function sendXHR(addressAndPort, endpoint, data, callbackFunction = () => { }) {
